...
describe(`Intern`, () => {
    ...
    it(`An error is thrown if school is not a string`, () => {
        const result = () => {
            new Intern(8, 'Edris Ilba', 'DCIJohnLuther@jlmail.com', 72);
        }
        expect(result).toThrow('Please provide a valid school');
    })
    // TEST 3
    it(`An error is thrown if school is an empty string`, () => {
        const result = () => {
            new Intern(8, 'Edris Ilba', 'DCIJohnLuther@jlmail.com', '');
        }
        expect(result).toThrow('Please provide a valid school');
    })
    ...
    it(`An Intern object is created when the id, name, email and school properties are provided`, () => {
        const intern = new Intern(8, 'Edris Ilba', 'DCIJohnLuther@jlmail.com', 'Skyfall School of Spectres');
        expect(intern).toEqual({
            id: 8,
            name: 'Edris Ilba',
            email: 'DCIJohnLuther@jlmail.com',
