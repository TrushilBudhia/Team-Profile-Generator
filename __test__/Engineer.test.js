...
describe(`Engineer`, () => {
    ...
    it(`An error is thrown if github is undefined`, () => {
        ...
        expect(result).toThrow('Please provide a valid GitHub link');
    })
    // TEST 2
    ...
    it(`An Engineer object is created when the id, name, email and github properties are provided`, () => {
        const engineer = new Engineer(7, 'Caniel Draig', 'CasinoRoyale007@jbmail.com', 'https://github.com/');
    ...
    it(`Returns the Engineer role when getGithub() is invoked`, () => {
        const engineer = new Engineer(7, 'Caniel Draig', 'CasinoRoyale007@jbmail.com', 'https://github.com/');
        expect(engineer.getGithub()).toEqual('https://github.com/');
    })
